...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint16_t {
      ...
      nxv2f16        = 102,   // n x  2 x f16
      nxv4f16        = 103,   // n x  4 x f16
      nxv8f16        = 104,   // n x  8 x f16
      nxv1f32        = 105,   // n x  1 x f32
      nxv2f32        = 106,   // n x  2 x f32
      nxv4f32        = 107,   // n x  4 x f32
      nxv8f32        = 108,   // n x  8 x f32
      nxv16f32       = 109,   // n x 16 x f32
      nxv1f64        = 110,   // n x  1 x f64
      nxv2f64        = 111,   // n x  2 x f64
      nxv4f64        = 112,   // n x  4 x f64
      nxv8f64        = 113,   // n x  8 x f64
      ...
      x86mmx         =  114,   // This is an X86 MMX value

      Glue           =  115,   // This glues nodes together during pre-RA sched

      isVoid         =  116,   // This has no value

      Untyped        =  117,   // This value takes a register, but has
                               // unspecified type.  The register class
                               // will be determined by the opcode.

      ExceptRef      = 118,    // WebAssembly's except_ref type
